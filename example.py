...
bot = InstaBot(login="x_archer_y", password="as12345678@",
               like_per_day=1000000,
               comments_per_day=10000,
               tag_list=['love','TagsForLikes','TagsForLikesApp','cute','l4l','likeforlike','like4like'],
               tag_blacklist=['rain', 'thunderstorm'],
               user_blacklist={},
               max_like_for_one_tag=40,
               follow_per_day=0,
               follow_time=1*60,
               unfollow_per_day=100000,
